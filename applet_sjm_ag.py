...
if __name__ == "__main__":
    ...
    df_binaries = read_feather("data/popsynth_HRD_outputs_extended_apr2026.feather")
    df_no_binaries = read_feather("data/popsynth_HRD_outputs_no-binaries_extended_apr2026.feather")
    solar_tracks = read_feather("data/solar_tracks.feather") 
    default_state = {
        "Teff": 9032, "Lum": 15.685,
        "e_Teff+": 180, "e_Teff-": 180,
        "e_Lum+": 0.678, "e_Lum-": 0.720
    }
